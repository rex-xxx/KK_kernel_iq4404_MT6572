...
static int mtk_dummyalsa_start(struct snd_pcm_substream *substream)
{
    printk("mtk_dummyalsa_start \n");
    return 0;
}
                        ...
                        void __user *dst, snd_pcm_uframes_t count)
{
    ...
    printk("dummy_pcm_copy pos = %d count = %d\n ", pos, count);
    count = count << 2;
	return 0;
}
...
static int mtk_alsa_stop(struct snd_pcm_substream *substream)
{
    printk("mtk_alsa_stop \n");
    return 0;
}
...
static const struct snd_kcontrol_new lsm_function[] = {
	...
	SOC_ENUM_EXT("test2", lsm_func_enum,
		     msm_routing_lsm_func_get, msm_routing_lsm_func_put),
	SOC_ENUM_EXT("test3", lsm_func_enum,
		     msm_routing_lsm_func_get, msm_routing_lsm_func_put),
	SOC_ENUM_EXT("test4", lsm_func_enum,
		     msm_routing_lsm_func_get, msm_routing_lsm_func_put),
		     */
};
